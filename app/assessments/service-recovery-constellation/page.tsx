...
export default function ServiceRecoveryConstellationPage() {
  ...
  if (complete) {
    return (
      <section className="scenario-shell">
        ...
        <h1>{result.passed ? "Constellation marked" : "Run reviewed"}</h1>
        <div className="result-grid">
          <article className="card badge-preview">
            <div className="badge-seal">↺</div>
            <h3>Customer Recovery</h3>
            <p className="muted">Service Recovery Constellation</p>
  ...
  return (
    <section className="scenario-shell">
      <p className="eyebrow">Service Recovery Constellation</p>
